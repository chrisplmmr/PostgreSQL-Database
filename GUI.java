    ...
    public GUI() {
        ...
        enterButton.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                try {
                    ...
                    if(id != -1){
                        if(id == 0){
                            ...
                            sqlStatement = "SELECT name FROM service";
                            fullResult = "--name--\n";
                            num_columns = 1;

                        } else if(id == 1){
                            //columnName = "business_id";
                            sqlStatement = "SELECT business_id, bikeparking FROM attributes";
                    ...
                    if (limit_number!="0") {
                        sqlStatement += " LIMIT " + limit_number;
                    }
                ...
                if ((Integer.parseInt(limit_number) <= 20) && (Integer.parseInt(limit_number)>0))
